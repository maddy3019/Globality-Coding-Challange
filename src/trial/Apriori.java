...
/**
 * @author Maddy
 * Ver 1.0 Nov 3, 2017 10:16:49 PM
 * 
 */
import java.io.*;
import java.util.*;
 ...
 * 
 * Usage with the command line : $ java mining.Apriori fileName support $ java
 * mining.Apriori /tmp/data.dat 0.8 $ java mining.Apriori /tmp/data.dat 0.8 >
...
public class Apriori extends Observable {
	 ...
	 * 
	 * @param args
	 *            configuration parameters: args[0] is a filename, args[1] the min
