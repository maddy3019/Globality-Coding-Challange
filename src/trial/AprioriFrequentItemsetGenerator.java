 ...
 * @author Maddy
 * Ver 1.0 Nov 3, 2017 10:20:10 AM
 * 
 */
...
public class AprioriFrequentItemsetGenerator<I> {
	 ...
	 *            the list of transactions to mine.
	 * @param minimumSupport
	 *            the minimum support.
	 * @return the object describing the result of this task.
	 */
	public FrequentItemsetData<I> generate(List<Set<I>> transactionList, int minimumSupport) {
	...
	/**
	 * This method simply concatenates all the lists of frequent itemsets into one
	 * list.
	 * 
	 * @param map
	 *            the map mapping an itemset size to the list of frequent itemsets
	 *            of that size.
	...
	/**
	 * Computes the list of itemsets that are all subsets of {@code transaction}.
	 * 
	 * @param candidateList
	 *            the list of candidate itemsets.
	 * @param transaction
	 *            the transaction to test against.
	 * @return the list of itemsets that are subsets of {@code transaction} itemset.
	 */
	 ...
	 * 
	 * @param itemsetList
	 *            the list of source itemsets, each of size <b>k</b>.
	 ...
	 * 
	 * @param itemset1
	 *            the list of elements in the first itemset.
	 * @param itemset2
	 *            the list of elements in the second itemset.
	 * 
	 ...
	 * @param supportCountMap
	 *            the support count map to which to write the support counts of each
	 *            item.
	 * @param minimumSupport
	 *            the minimum support.
	...
	private List<Set<I>> findFrequentItems(List<Set<I>> itemsetList, Map<Set<I>, Integer> supportCountMap,
		...
		for (Map.Entry<I, Integer> entry : map.entrySet()) {
			if (entry.getValue() >= minimumSupport) {
